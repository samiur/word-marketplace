...
{var rank = cljs.core.constant$keyword$150.cljs$core$IFn$_invoke$arity$1(stats);var advice = (((rank < 100))?"Think long and hard before using it!":"Make sure you've explored all your options before using it.");return (kioo.om.content.cljs$core$IFn$_invoke$arity$1 ? kioo.om.content.cljs$core$IFn$_invoke$arity$1((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(word__$1)+" is the "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(word_marketplace.core.rank_text(rank))+" most commonly used word on nonprofit websites. "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(advice))) : kioo.om.content.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(word__$1)+" is the "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(word_marketplace.core.rank_text(rank))+" most commonly used word on nonprofit websites. "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(advice))));
} else
{return (kioo.om.content.cljs$core$IFn$_invoke$arity$1 ? kioo.om.content.cljs$core$IFn$_invoke$arity$1(("Congratulations -- "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(word__$1)+" is not in the top 1000 words found on nonprofit websites!")) : kioo.om.content.call(null,("Congratulations -- "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(word__$1)+" is not in the top 1000 words found on nonprofit websites!")));
}
} else
